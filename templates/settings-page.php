...
<main class="page">
    <header class="rasa-container">
        <div>
            <div>
                ...
                <p><strong><?php esc_html_e('Rasa Link', 'rasa-link'); ?></strong> - <?php esc_html_e('Easily shorten your long links', 'rasa-link'); ?></p>
            </div>
            <div class="rasa-logo">
                <img src="<?php echo esc_url(RASA_LINK_PLUGIN_URL . 'assets/img/logo.png'); ?>"
                     alt="<?php esc_attr_e('Rasa Link Logo', 'rasa-link'); ?>">
                <span class="rasa-version"><?php esc_html_e('Version 1.0.0', 'rasa-link'); ?></span>
            </div>
        </div>
    </header>
    ...
    <section class="tabs">
        ...
        <div class="pcss3t pcss3t-effect-scale pcss3t-theme-1" role="tablist">
            ...
            <label for="tab1"><?php esc_html_e('API Key', 'rasa-link'); ?></label>

            <input type="radio" name="pcss3t" id="tab2" class="tab-content-2">
            <label for="tab2"><?php esc_html_e('Shortcode', 'rasa-link'); ?></label>

            <input type="radio" name="pcss3t" id="tab3" class="tab-content-3">
            <label for="tab3"><?php esc_html_e('Links', 'rasa-link'); ?></label>

            <input type="radio" name="pcss3t" id="tab5" class="tab-content-last">
            <label for="tab5"><?php esc_html_e('Channels', 'rasa-link'); ?></label>
            ...
            <ul>
                <li class="tab-content tab-content-first typography" role="tabpanel">
                    ...
                    <form action="#" method="post">
                        <label for="api-key"><?php esc_html_e('API Key', 'rasa-link'); ?></label>
                        <input id="api-key" name="api-key" type="text"
                               placeholder="<?php esc_attr_e('API Key', 'rasa-link'); ?>"
                ...
                <li class="tab-content tab-content-3 typography" role="tabpanel">
                    ...
                    <div class="table-container">
                        <table>
                            <thead>
                            <tr>
                                <th><?php esc_html_e('ID', 'rasa-link'); ?></th>
                ...
                <li class="tab-content tab-content-last typography" role="tabpanel">
                    ...
                    <form action="#" method="post">
                        <label for="name-channel"><?php esc_html_e('Name', 'rasa-link'); ?></label>
                        <input id="name-channel" name="name-channel" type="text"
                               placeholder="<?php esc_attr_e('Name', 'rasa-link'); ?>">
                        <button class="btn-save-channel"
                                aria-label="<?php esc_attr_e('Save Channel', 'rasa-link'); ?>">
                            <?php esc_html_e('Save', 'rasa-link'); ?>
                        </button>
                    </form>
